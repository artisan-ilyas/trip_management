...
<div class="content-wrapper">
    <div class="container-fluid pt-3"> <!-- container-fluid for full width -->
        ...
        <div class="table-responsive"> <!-- makes table scroll horizontally on small screens -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            ...
                            <a href="{{ route('admin.slots.documents.harbormaster', $slot) }}" class="btn btn-sm btn-primary" target="_blank">Harbormaster Manifest</a>
                            <a href="{{ route('admin.slots.documents.crew_guest_sheet', $slot) }}" class="btn btn-sm btn-secondary" target="_blank">Crew Guest Sheet</a>
